create_globe_project = function(name,year,description,image,position){
    ...
    title = name+" ["+year+"]";
    return '<div style="clear:both;"></div><div class="globe_portfolio" style="display:none;"><div class="'+row+'"></div><img id="logo" src="'+image+'" /><div id="title">'+title+'</div><div id="description">'+description+'</div></div>';
}
